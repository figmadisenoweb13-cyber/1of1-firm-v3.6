      ...
      <div className="relative pt-20">
        ...
        <div className="relative z-10 px-4 md:px-8 py-8 md:py-12">
          ...
          <div className="text-center mb-8">
            <h1 className="text-xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-none">
          ...
          {/* Subtitle */}
          <p className="text-center text-white/60 text-[6px] md:text-base tracking-[0.15em] mb-4 md:mb-8 max-w-md mx-auto">
          ...
          >
            <div className="flex flex-col md:flex-row">
              ...
              <div className="p-4 md:p-6 flex-1">
                ...
                {/* Title */}
                <div className="mb-3">
                  <h2 className="text-base md:text-4xl font-bold tracking-wider text-white">
                    ANIMAL
                  </h2>
                  <span className={`text-sm md:text-3xl ${event.subtitleStyle === "script" ? "font-serif italic" : "italic font-light"} text-amber-500`}>
                    {event.subtitle}
                  </span>
                </div>
          ...
          <div className="bg-zinc-900/60 border border-white/10 rounded-xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-[10px] md:text-lg font-bold tracking-wider mb-1">MESA VIP 10 PERSONAS</h3>
                <p className="text-white/50 text-[6px] md:text-sm tracking-wider mb-2 md:mb-3">EXPERIENCIA VIP PARA GRUPOS</p>
                <div className="mb-2 md:mb-3">
                  <span className="text-base md:text-3xl font-light text-white">$500.000</span>
