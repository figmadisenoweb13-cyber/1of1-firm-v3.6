        ...
        <div className="flex-1 p-4 md:p-5 flex flex-col justify-between">
          <div>
            ...
            <div className="flex items-start justify-between gap-2">
              <h3 className="text-[10px] md:text-2xl font-light tracking-wider text-white">{title}</h3>
              {edition && (
            ...
            {/* Subtitle */}
            <p className="text-amber-500/80 text-[6px] md:text-xs tracking-[0.15em] uppercase mt-1">{subtitle}</p>
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative pt-24 pb-8 px-4">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-base md:text-5xl font-light tracking-wider italic">SIGNATURE EVENTS</h1>
          <p className="text-white/50 text-[6px] md:text-xs tracking-[0.2em] mt-1 md:mt-2 uppercase">
